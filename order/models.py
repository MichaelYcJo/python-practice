...
class Order(models.Model):
    # order_status 에 따른 이메일 발송도 고려할것 
    ...
    paid = models.BooleanField(default=False) #결제완료여부
...
class OrderTransactionManager(models.Manager):
    def create_new(self, order, amount, success=None, transaction_status=None):
        ...
        # order_id 를 hashing 하고 hex까지 먹여서 보안
...
class OrderTransaction(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2, default=0) #소수점을 안받아도 된다면 positiveIntegerField 대체가능
