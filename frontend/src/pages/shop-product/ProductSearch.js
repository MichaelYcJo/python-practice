...
const ProdutSearch = ({location}) => {
    ...
    }, [offset, searchProducts, sortType, sortValue, filterSortType, filterSortValue, location ]);
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3 order-2 order-lg-1">
                                {/* shop sidebar */}
                                <ShopSidebar products={searchProducts} getSortParams={getSortParams} sideSpaceClass="mr-30"/>
                            </div>
                            <div className="col-lg-9 order-1 order-lg-2">
                                {/* shop topbar default */}
                                <ShopTopbar getLayout={getLayout} getFilterSortParams={getFilterSortParams} productCount={searchProducts.length} sortedProductCount={currentData.length} />
